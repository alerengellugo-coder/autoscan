                    ...
                    {mobileMenuOpen && (
                        <div className="md:hidden border-t border-gray-200 py-4 animate-slide-down">
                            <div className="flex flex-col gap-2">
                                ...
                                <Link
                                    href="/register"
                                    className="block mx-4 btn-primary text-sm text-center"
                                    onClick={() => setMobileMenuOpen(false)}
                                >
                                    Registrarse
                                </Link>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="text-sm text-gray-400 max-w-md">
                                Somos especialistas en diagnóstico automotriz
                                profesional. Ofrecemos servicios de escaneo
                                electrónico, mantenimiento preventivo y
                                reparación integral para tu vehículo.
                            </p>
                    ...
                    <div className="border-t border-dark-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-gray-500">
                            © {new Date().getFullYear()} AutoScan. Todos los
                            derechos reservados.
                        </p>
