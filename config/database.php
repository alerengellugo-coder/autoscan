...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Redis is an open source, fast, and in-memory key-value data store
    | that also provides a message broker. This configuration defines
    | the connection details for your application's Redis servers.
    |
    */
